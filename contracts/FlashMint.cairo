...
@constructor
func constructor {syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(name : felt, symbol : felt, decimals : felt){
    ERC20.initializer(name, symbol, decimals);
    return();
}

@view
func maxFlashLoan {syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(token_address : felt) -> (total_supply : Uint256){
...
func getFlashLoanFees {syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(token_address : felt, amount : Uint256) -> (fee : Uint256) {
    ...
    let (token_support : felt) = IERC3156FlashLender.is_supported_token(contract_address,token_address);
